      ...
      <div className="space-y-6">
        <div className="text-center py-8">
          ...
          <p className="text-muted-foreground">
            No actress collaborations found for {actorName}.
          </p>
          <p className="text-sm text-muted-foreground mt-2">
            This actor hasn't appeared in movies with any actresses yet.
          </p>
        </div>
      </div>
    )
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4 p-4 bg-muted/50 rounded-lg">
        ...
        <div className="ml-auto text-sm text-muted-foreground">
          {filteredAndSortedActresses.length} actresses collaborated with {actorName}
        </div>
      </div>
      ...
      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
        <div className="font-medium mb-1">💡 Collaboration View</div>
        <div className="text-xs space-y-1">
          <div>• Shows actresses who appeared in movies with {actorName}</div>
          <div>• Collaboration count shows how many movies they appeared together</div>
